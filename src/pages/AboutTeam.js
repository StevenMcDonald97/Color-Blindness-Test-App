...
const AboutTeam = () => {
  return (
    <div style={{ margin: "2rem" }}>
      ...
      <div>
        <h3>Kavitha Krishnamurthy</h3>
        <p>
          I live in Chennai, TamilNadu and I'm driven by my passion to build and
          create something that will have an enduring impact on society. I
          believe that we are not remembered by the amount of money we have made
          but rather by the lives we have changed in the process.This website is
          a passion project of mine, developed with the aim of creating
          awareness and diagnosing color blindness and hearing problems among
          the people of India and my sincere thanks to NGO name, Hsueh Yen Neo,
          Steven McDonald and Joey Bruno for making this possible.
        </p>
        <img
          src={kavithaPhoto}
      ...
      <div>
        ...
        <p>
          ...
          join the project in order to help people, by using my mixed skills of
          graphic design and web development to help assist in the designing of
          the website itself.
        </p>
